...
export interface PrivateDelegationInput {
...
export interface Client {
   ...
   */
  delegate_private_root: ({session_id, source_note_id, delegation, proof}: {session_id: Buffer, source_note_id: Buffer, delegation: PrivateDelegationInput, proof: Groth16Proof}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
  ...
  /**
   * Construct and simulate a delegate_private_budget transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  delegate_private_budget: ({session_id, source_note_id, delegation, proof}: {session_id: Buffer, source_note_id: Buffer, delegation: PrivateDelegationInput, proof: Groth16Proof}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
