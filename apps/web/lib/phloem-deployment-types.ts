...
export const PHLOEM_UPLOAD_FEE_LIMIT_STROOPS = "198110151";
export const PHLOEM_UPLOAD_FEE_TOLERANCE_BPS = 100n;
export const PHLOEM_CONTRACT_SOURCE_REVISION = "164d0ed224b2cacedcc9afb9252dff0705fa4ec2";
